...
# Current expected app version after the v3.54 patch chain.
grep -q 'MARKETING_VERSION="3.54"' scripts/build_unsigned_ipa.sh   || fail "expected MARKETING_VERSION 3.54 not present"
grep -q 'CURRENT_PROJECT_VERSION="59"' scripts/build_unsigned_ipa.sh   || fail "expected build number 59 not present"
