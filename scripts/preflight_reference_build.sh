...
# Current expected app version after the v3.47 patch chain.
grep -q 'MARKETING_VERSION="3.47"' scripts/build_unsigned_ipa.sh   || fail "expected MARKETING_VERSION 3.47 not present"
grep -q 'CURRENT_PROJECT_VERSION="52"' scripts/build_unsigned_ipa.sh   || fail "expected build number 52 not present"
