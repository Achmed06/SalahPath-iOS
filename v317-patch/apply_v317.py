...
# SalahPath v3.17: replace generic iOS settings form with SalahPath profile/settings UI.
            ...
            VStack(spacing: 11) {
                ...
                referenceSection(settings.t("Gebetszeiten", "Namaz vakitleri")) {
                    Menu {
                        ...
                        profileRow(icon: "clock.fill", title: settings.t("Berechnung", "Hesaplama"), value: settings.calculationPreset.title)
                    }
...
s = s.replace('MARKETING_VERSION="3.16"', 'MARKETING_VERSION="3.17"')
s = s.replace('CURRENT_PROJECT_VERSION="21"', 'CURRENT_PROJECT_VERSION="22"')
p.write_text(s, encoding="utf-8")

print("SalahPath v3.17 profile/settings visual parity patch applied")
